...
//    }
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull final Result result) {
    ...
    if (call.method.equals(Common.Method_Mute_Conversation)) {
      ...
      AVIMMessageIntervalBound start = Common.parseAVIMMessageIntervalBound(startData);
      AVIMMessageIntervalBound end = Common.parseAVIMMessageIntervalBound(endData);
